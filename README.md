...
A `package.json` fájlt tartalmazza a project fontosabb paramétereit. Fontos metaadatokat rögzít a projektről, amelyekre szükség van az NPM-be való közzététel előtt, valamint meghatározza a projekt funkcionális attribútumait, amelyeket az npm a függőségek telepítéséhez, szkriptek futtatásához és a csomag belépési pontjának azonosításához használ.
...
__NOTE__A 404-es hibakezelő middleware-t mindig a route-ok után kell elhelyezni, hogy a többi route ellenőrzése után fusson le.
